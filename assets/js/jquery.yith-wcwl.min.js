    ...
    $(document).on( 'yith_wcwl_init', function(){
        ...
        t.on( 'click', '.add_to_wishlist', function( ev ) {
            var t = $(this),
             ...
             var modelopen = jQuery(this).attr('openmobel');
            ...
            $.ajax({
                ...
                success: function( response ) {
					...
					$.each(response.user_wishlists, function(i,wishlists) {
						$('.change_wishlist_select').attr('wishlist_id', wishlists.id);
					});
                }
            });
