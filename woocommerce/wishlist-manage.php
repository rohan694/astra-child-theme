		...
		<tr>
			<th class="wishlist-name">
				<span class="nobr">
					 ...
					 * @return string
					 */
					echo esc_html( apply_filters( 'yith_wcwl_wishlist_manage_default_heading', __( '', 'yith-woocommerce-wishlist' ) ) );
					?>
				</span>
			</th>
		...
		foreach ( $user_wishlists as $wishlist ) : ?>
			...
			<tr data-wishlist-id="<?php echo esc_attr( $wishlist->get_id() ); ?>">
				...
				<td class="wishlist-name">
					<a class="wishlist-default" onclick="return confirm('<?php esc_html_e( 'Are you sure you want to make this wishlist default?', 'yith-woocommerce-wishlist' ); ?>');" href="<?php echo esc_url( YITH_WCWL()->get_wishlist_url( 'manage' ) . "?yith_wcwl_set_default=" . $wishlist->get_token() ); ?>"><i class="fa <?php if( $wishlist->is_default() ) { echo "fa-star"; } else { echo "fa-star-o"; } ?>"></i></a>
				</td>

				<td class="wishlist-name">
					<div class="wishlist-title">
						<a title="<?php echo esc_attr( $wishlist->get_formatted_name() ); ?>" class="wishlist-anchor" href="<?php echo esc_url( $wishlist->get_url() ); ?>">
							<?php echo esc_html( $wishlist->get_formatted_name() ?: 'My wishlist' ); ?>
						</a>
